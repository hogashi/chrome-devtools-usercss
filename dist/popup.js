...
var lastSelectedHostname = function () {
  var lastSelected = localStorage.getItem(LAST_SELECTED_HOST_NAME) || '';
  return initHostnameSet[lastSelected] ? lastSelected : '';
}();

var setLastSelectedHostname = function setLastSelectedHostname(hostname) {
...
var App = function App() {
  ...
  var _useState9 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(SAVE_BUTTON_INIT_VALUE),
      ...
      saveButtonValue = _useState10[0],
      setSaveButtonValue = _useState10[1];
...
react_dom__WEBPACK_IMPORTED_MODULE_2__.render( /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(App, {}), document.querySelector('#root'));
})();
